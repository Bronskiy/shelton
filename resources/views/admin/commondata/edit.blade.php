...
<div class="form-group">
  ...
  {!! Form::label('common_contact_details', 'Реквизиты', array('class'=>'col-sm-2 control-label')) !!}
  <div class="col-sm-10">
    {!! Form::textarea('common_contact_details', old('common_contact_details',$commondata->common_contact_details), array('class'=>'form-control ckeditor')) !!}
